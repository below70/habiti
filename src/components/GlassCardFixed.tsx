...
const GlassCardFixed: React.FC<GlassCardProps> = ({
  blurIntensity: blurAmount = blurIntensity.medium,
  borderRadiusSize = borderRadius.medium,
  ...
  const animatedStyle = useAnimatedStyle(() => {
    ...
    return {
      ...
      backfaceVisibility: 'hidden' as const, // Reduces flickering on iOS
    };
  });
